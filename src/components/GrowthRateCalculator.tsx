...
export default function GrowthRateCalculator() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 bg-slate-900 text-slate-100 rounded-2xl shadow-xl border border-slate-800" dir="rtl">
      <div className="flex flex-col md:flex-row md:items-center justify-between pb-6 border-b border-slate-800 gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            حساب معدل النمو النوعي (μ) وزمن المضاعفة (t_d) لإنماء الطحالب الدقيقة بالاعتماد على الكثافة الضوئية (OD_600).
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-6">
        <div className="lg:col-span-5 space-y-4">
            ...
            <table className="w-full text-xs text-right text-slate-300">
              <thead className="bg-slate-800/80 text-slate-400 border-b border-slate-800">
                <tr>
                  ...
                  <th className="p-2.5">الكثافة (OD)</th>
                  ...
                  <tr key={point.id} className="hover:bg-slate-800/30">
                    <td className="p-2">
                      <input
                        ...
                        className="w-full bg-slate-900 border border-slate-700 rounded px-2 py-1 text-slate-200 focus:border-emerald-500 outline-none text-left"
                        dir="ltr"
                      />
                    </td>
                    <td className="p-2">
          ...
          <div className="p-4 bg-slate-800/40 rounded-xl border border-slate-800 space-y-3">
            <h4 className="text-xs font-bold text-slate-300">تحديد مرحلة النمو اللوغاريتمي:</h4>
        ...
        <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
              <span className="text-xs text-emerald-400 font-medium block">معدل النمو النوعي (μ)</span>
              <div className="text-3xl font-extrabold text-emerald-400 mt-1 text-right" dir="ltr">
            ...
            <div className="p-4 bg-cyan-500/10 border border-cyan-500/20 rounded-xl">
              ...
              <div className="text-3xl font-extrabold text-cyan-400 mt-1 text-right" dir="ltr">
